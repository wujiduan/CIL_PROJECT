...
1. Add the extra data in *Additional data and data preprocessing*, make sure they are in the correct corresponding directory. What we provide in this branch are "Original + Additional + Original Transformed + Additional Transformed" images, and a validation set (the validation folder) hasa already been randomly sampled. If you want to directly get the result from this step, you can download it from https://polybox.ethz.ch/index.php/s/kM4qJPLEj66SsxW.
   At the same time we also provide you a link: https://polybox.ethz.ch/index.php/s/WYo97Fo0GbYB6tu to get the additional images without any transformation, and if you want to reproduce the results of this step, please run transform.ipynb. Please make sure that all folder paths are correct. Here I would like to explain again that because the transform is random, the image quality may fluctuate and affect the final result, but this is reasonable.
